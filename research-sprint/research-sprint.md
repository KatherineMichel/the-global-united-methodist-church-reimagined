...
LifeChurch and its Bible App begain very similarly to other technology startups (such as Amazon, Google) that have disrupted industries, with founders with previous web development and entrepreneurial experience (literally) working out of a garage. 

![](images/united-methodist-church-model.jpg)

The United Methodist Church, still  in the world is far from fully capitalizing on the opportunity to create a network effect using its pre-existing membership base and potential ecumenical users. The United Methodist Church is also failing to streamline its online offerings, and currently does not have any mobile app, missing the opportunity to fully capitalize on the shift to smartphones, including mobile-only developing countries where new membership in the United Methodist Church tends to be skyrocketting (unlike in the U.S. and other developed parts of the world, where membership is declining). 
